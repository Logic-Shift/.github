...
To get started contributing we first ask of you to just mess around with everything that's there.
Look at the issues and pull-requests that are there. Try to understand why the codebase before wanting to have your pull-request accepted.
...
Contact the maintainers in private if you think the issue is a security risk.
...
1. [Install Git](hhttps://docs.github.com/en/get-started/quickstart/set-up-git).
...
3. Install or update the applications on your machine to prevent any errors during the process (e.g. correct nodejs version).
...
Once your PR is merged, your contributions will be visible!

## Windows
Developing on Windows won't cause any problems most of the time. But please check for a few potential gotchas that need to be kept in mind:
